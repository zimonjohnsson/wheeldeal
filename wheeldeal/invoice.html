...
<body onload="loadCart()">
    <div class="invoice" style="max-width: 1000px;">
        <div class="header">
        ...
        <div class="info">
            <div>
                <p><strong>From:</strong> Wheeldeal</p>
                <p>Carl Krooks gata 9</p>
                <p>Helsingborg, 252 25</p>
            </div>
            <div>
                <p><strong>To:</strong> <span id="customerName"></span></p>
        ...
        <div id="invTotal">
            <p id="totalPrice"> <strong>Total Amount:</strong> $100.00 </p>
        </div>
    </div>
